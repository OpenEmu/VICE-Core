...
/* Define to 1 if you have the `libogg' library (-llibogg). */
/* #undef HAVE_LIBLIBOGG */

/* Define to 1 if you have the `libvorbis' library (-llibvorbis). */
/* #undef HAVE_LIBLIBVORBIS */

/* Define to 1 if you have the `libvorbisenc' library (-llibvorbisenc). */
/* #undef HAVE_LIBLIBVORBISENC */

/* Define to 1 if you have the `libvorbisfile' library (-llibvorbisfile). */
/* #undef HAVE_LIBLIBVORBISFILE */
...
// OpenEmu Config Options

/* Use the printer feature */
// #define HAVE_PRINTER

/* Enable AudioUnit support. */
// #define USE_AUDIOUNIT /**/

// #define USE_FILE_AUDIO

/* Enable OpenEmu sound device */
#define USE_OPENEMU_AUDIO